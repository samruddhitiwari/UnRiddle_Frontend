        ...
        >
            <div className="w-full max-w-md">
                ...
                <div className="mb-8">
                    ...
                    >
                        <FileText className="w-7 h-7" style={{ color: 'var(--text-primary)' }} />
                    </div>
                    <h1 className="heading-lg">Unriddle</h1>
                ...
                <div className="brutalist-card p-8">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 font-medium transition-all disabled:opacity-50"
                        style={{
                    ...
                    <div className="flex items-center my-6">
                        <div className="flex-1 h-px" style={{ backgroundColor: 'var(--border-dark)' }}></div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                minLength={6}
                                className="w-full pl-11 pr-12 py-3 focus:outline-none"
                                style={{
                                    backgroundColor: 'var(--bg-white)',
                                    border: '2px solid var(--border-dark)',
                                    borderRadius: '8px',
                    ...
                    <p className="text-center mt-6" style={{ color: 'var(--text-body)' }}>
